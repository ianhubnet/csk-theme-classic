<?php defined('BASEPATH') || exit('A moment of silence for your attempt.'); ?><div class="row justify-content-center">
	<div class="col-12 col-md-8 col-lg-6 col-xl-4">
		<h1 class="text-center h4 mb-2"><?php _e('quick_login_request') ?></h1>

		<div class="card">
			<?php echo form_open('quick-login', 'role="form" id="quick-login" class="card-body"', $hidden) ?>
				<p class="mb-3"><?php _e('quick_login_tip') ?></p>
